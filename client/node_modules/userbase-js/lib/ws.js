...
class Connection {
  ...
  connect(session, seedString = null, rememberMe, reconnectDelay, state) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const url = "".concat(getWsUrl(config.getEndpoint()), "/api?appId=").concat(config.getAppId(), "&sessionId=").concat(session.sessionId, "&clientId=").concat(clientId);
      ...
      resolveConnection((await new Promise((resolve, reject) => setTimeout(async () => {
        try {
          const state = currentState || {
            ...
            dbIdToHash: _objectSpread({}, this.state.dbIdToHash),
